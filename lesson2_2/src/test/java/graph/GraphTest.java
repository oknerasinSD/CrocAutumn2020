...
public class GraphTest {
    ...
    public void findComponentsTest() {
        ...
        /*
        Проверяем, что в графе всего одна компонента связности, в которую входяя все 9 вершин.
         */
        ...
        в качестве имени вершины объектов самописного класса получается вот такая многоэтажная проверка,
